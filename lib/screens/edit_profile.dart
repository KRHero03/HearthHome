...
class EditProfileHostState extends State<EditProfileHostScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    dbRef.once().then((snapshot){
      setState((){
        _nameController.text = snapshot.value['Name'];
        latitude = double.parse(snapshot.value['Address']['Latitude']);
        longitude = double.parse(snapshot.value['Address']['Longitude']);
        _addressController.text =snapshot.value['Address']['Value'];
        _govCode.text = snapshot.value['GovID'];
        _pinCodeController.text = snapshot.value['Address']['Pincode'];
        _adultMaleController.text = snapshot.value['Household']['AdultMale'];
        _adultFemaleController.text = snapshot.value['Household']['AdultFemale'];
        _childrenMaleController.text = snapshot.value['Household']['childrenMale'];
        _childrenFemaleController.text = snapshot.value['Household']['childrenFemale'];
        govIDURL = snapshot.value['GovIDURL'];
        houseImage = snapshot.value['HouseImages'].toString().split(',');
      });
    });
